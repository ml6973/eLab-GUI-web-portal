...
class vmInfo {
	public static function show($imageName) {
		...
		echo '<p><a class="btn btn-success btn-block btn-lg vmIP" id="'.$imageName.'" data-uname="'.$userName.'" data-uid="'.$userId.'" role="button">Access Environment</a></p>';
	...
	public static function showCustom($imageName, $type) {
		...
		if (!is_null($type) && strcmp($type, "jupyter") == 0) {
			echo '<p><a class="btn btn-success btn-block btn-lg vmIP" id="'.$imageName.'" data-uname="'.$userName.'" data-uid="'.$userId.'" data-vmtype=jupyter role="button">Access Environment</a></p>';
			echo '<div class="row" id="'.$imageName.'_info" hidden>
	...
	public static function showDisabled() {
		echo '<p><a class="btn btn-success btn-block btn-lg vmIP disabled" role="button">Access Environment</a></p>';
	}
}
//<p><input class="form-control" id="'.$imageName.'_command" type="text" value="" readonly="readonly"></p>
?>